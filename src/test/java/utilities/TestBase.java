...
public abstract class TestBase {
    //abstract yapma nedenimiz bu sinifin objesini olusturmak istemiyorum
    //amacim bu sinifi extend etmek ve icindeki hazir methodlari kullanmak
    //    TestBase testBase = new TestBase(); -> YAPILAMAZ

    //driver objesini olustur.Driver ya public yada protected olmali.Sebebi child classlarda gorulebilmesi
    protected static WebDriver driver; //tum framework de ortak olarak kullanma mantigimiz o yuzden static yaptik
...
//        driver = new ChromeDriver();
    ...
    //index numarasini parametre olarak alir ve o indexli pencerede gecis yapar
